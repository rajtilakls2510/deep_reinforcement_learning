...
import cv2
from interface import LunarLanderTerminal, LunarLanderImageInterpreter
...
interpreter = LunarLanderImageInterpreter(LunarLanderTerminal(gym.make("LunarLander-v2")), frame_buffer_size=FRAME_BUFFER_SIZE, preprocessed_frame_shape=PREPROCESSED_FRAME_SHAPE)

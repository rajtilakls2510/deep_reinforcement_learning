...
from tensorflow.keras.layers import Dense, Rescaling, Conv2D, GlobalAveragePooling3D
from tensorflow.keras.optimizers import Adam

from deep_rl.agent import Agent
from deep_rl.algorithms import DeepQLearning
from deep_rl.analytics import AvgTotalReward
from lunarlander.interface import LunarLanderTerminal, LunarLanderImageInterpreter

AGENT_PATH = "lunar_lander_agent3"
FRAME_BUFFER_SIZE = 5
PREPROCESSED_FRAME_SHAPE = (80, 80, 3)
interpreter = LunarLanderImageInterpreter(LunarLanderTerminal(gym.make("LunarLander-v2")),

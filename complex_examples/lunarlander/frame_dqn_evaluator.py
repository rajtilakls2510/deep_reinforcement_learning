...
env = LunarLanderImageEnvironment(gym.make("LunarLander-v2", render_mode = "rgb_array"), frame_buffer_size=FRAME_BUFFER_SIZE, preprocessed_frame_shape=PREPROCESSED_FRAME_SHAPE)

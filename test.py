...
x1 = layers.Dense(16, activation="relu")(obs_agent_inp)
x1 = layers.Flatten()(x1)

act_agent_inp = layers.Input(shape=(2,5))
x2 = layers.Dense(16, activation="relu")(act_agent_inp)
x2 = layers.Flatten()(x2)

# Adversary Agents Heads
obs_adversary_inp = layers.Input(shape=(1,8))
x3 = layers.Dense(32, activation="relu")(obs_adversary_inp)
x3 = layers.Flatten()(x3)

act_adversary_inp = layers.Input(shape=(1,5))
x4 = layers.Dense(32, activation="relu")(act_adversary_inp)
...
algorithm = MADDPG(env, env.agents, env.adversaries, actor_network, actor_adversary_network,
                   critic_network, replay_size=100000, exploration=0.5)
algorithm.train(initial_episode=0, episodes=1000, batch_size=32, metrics=[total_reward, ep_length])
